# download from: https://github.com/pytorch/examples/blob/main/imagenet/main.py
import argparse
import os
import random
import shutil
...
def main():
    args = parser.parse_args()  # 根据前面的设置解析
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        if args.multiprocessing_distributed:
            # For multiprocessing distributed train
            # ing, rank needs to be the
    ...
    if args.pretrained:
        ...
        model = net.resnet18(num_classes=200)
    ...
    if args.distributed:
        ...
        train_sampler = None
        val_sampler = None
    # train_loader的长度为100k/256(batch_size)=391
...
def train(train_loader, model, criterion, optimizer, epoch, device, args):
    ...
    top5 = AverageMeter('Acc@5', ':6.2f')  # 定义指标
    ...
    running_loss = 0.0
    running_acc5 = 0.0
    for i, (images, target) in enumerate(train_loader):  # 取一个mini batch
...
class ProgressMeter(object):
    def __init__(self, num_batches, meters, prefix=""):
        ...
        self.meters = meters
        self.prefix = prefix  # prefix为Epoch[x]或Test
...
if __name__ == '__main__':
    ...
    print("共计耗时{}min {}s".format(mins, round(secs, 2)))
